...
public class Semantico {
  ...
  private static void g() throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
    ...
    private static void cmd_only_one_assignment() throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
        if (token == T_VAR) {
            buscaProximoToken();
  ...
  private static void variable() throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
    ...
    private static void variableSemVerificacaoExists() throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
      id();
      regraSemantica( 41 );
      acumulaRegraSintaticaReconhecida( "<VARIABLE> ::= <ID>" );
  }
  ...
  private static void cmd() throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
    ...
    // <CMD_IF> ::= 'IF(' <CONDICAO>') {' <CMDS> '}' 
    // <CMD_IF> ::= 'IF(' <CONDICAO>') {' <CMDS> '} ELSE {' <CMDS> '}' 
    private static void cmd_if() throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
        if (token == T_IF) {
            buscaProximoToken();
            if (token == T_OPEN_PAR) {
                buscaProximoToken();
    ...
    // <CMD_WHILE> ::= 'WHILE(' <CONDICAO> ') {' <CMDS> '}'
    private static void cmd_while() throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
        if (token == T_WHILE) {
            buscaProximoToken();
    ...
    // <CMD_FOR> ::= 'FOR(' <CMD_ONLY_ONE_ASSIGNMENT> 'TO' <E> ') {' <CMDS> '}
    private static void cmd_for() throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
        if (token == T_FOR) {
            buscaProximoToken();
            if (token == T_OPEN_PAR) {
                buscaProximoToken();
    ...
    // <CMD_FOREACH> ::= 'FOREACH(' <VAR> <E> 'IN' <E> ') {' <CMDS> '}' 
    private static void cmd_foreach() throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
        if (token == T_FOREACH) {
            buscaProximoToken();
            if (token == T_OPEN_PAR) {
                buscaProximoToken();
    ...
    // <CMD_CASE_OR_DEFAULT> ::= ''CASE'|'DEFAULT' '<E>':'|':'' <CMDS> 'BREAK;'
    private static void cmd_case_or_default() throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
    ...
    private static void cmd_switch() throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
        if (token == T_SWITCH) {
            buscaProximoToken();
    ...
    // <CMD_ASSIGNMENT> ::= <VAR> '=' <E>
    private static void cmd_assignment() throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
        variable();
    ...
    private static void cmd_assignment_sem_verificacao_var() throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
    ...
    // <CMD_READ> ::= 'READ' '(' <VAR> ')' 
    private static void cmd_read() throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
        if (token == T_READ) {
            buscaProximoToken();
            if (token == T_OPEN_PAR) {
                buscaProximoToken();
    ...
    // <CMD_WRITE> ::= 'WRITE' '(' <E> ')'
    private static void cmd_write() throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
        if (token == T_WRITE) {
            buscaProximoToken();
            if (token == T_OPEN_PAR) {
                buscaProximoToken();
    ...
    // <E> ::= <E> - <T>
    // <E> ::= <T>
    private static void e(boolean comValidacaoSeTokenExiste) throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
        t(comValidacaoSeTokenExiste);
        while ((token == T_PLUS) || (token == T_MINUS)) {
		  switch( token ) {
	      case T_PLUS: { buscaProximoToken();
                    t(comValidacaoSeTokenExiste);
                    regraSemantica( 5 );
	      	   }
	           break;
	      case T_MINUS: { buscaProximoToken();
	      				  t(comValidacaoSeTokenExiste);
	      				  regraSemantica( 6 );
	      	   }
	           break;
    ...
    // <T> ::= <T> % <F>
    // <T> ::= <F>
    private static void t(boolean comValidacaoSeTokenExiste) throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
        f(comValidacaoSeTokenExiste);
        while ((token == T_TIMES) || (token == T_DIVISION) || (token == T_REMAINDER)) {
		  switch ( token ) {
		  case T_TIMES: { buscaProximoToken();
		  				  f(comValidacaoSeTokenExiste);
		  				  regraSemantica( 7 );
		  				}
		                break;
		  case T_DIVISION: { buscaProximoToken();
			  				 f(comValidacaoSeTokenExiste);
			  				 regraSemantica( 8 );
						   }
		                break;
		  case T_REMAINDER: { buscaProximoToken();
			 		  	  f(comValidacaoSeTokenExiste);
			 		  	  regraSemantica( 9 );
		  				}
		                break;
    ...
    // <F> ::= <X> ** <F>
    // <F> ::= <X>     
    private static void f(boolean comValidacaoSeTokenExiste) throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
        if (token == T_MINUS) {
            buscaProximoToken();
            f(comValidacaoSeTokenExiste);
        } else {
    ...
    // <X> ::= [0-9]+('.'[0-9]+)
    // <X> ::= <VAR>
    private static void x(boolean comValidacaoSeTokenExiste) throws IOException, ErroLexicoException, ErroSintaticoException, ErroSemanticoException {
        switch (token) {
            case T_ID:
                buscaProximoToken();
    ...
    static void regraSemantica( int numeroRegra ) throws ErroSemanticoException {
        ...
        switch ( numeroRegra ) {
            ...
            case  3:	nodo_2 = pilhaSemantica.pop();
                        ...
                        codigoJava.append( tabulacao( nivelIdentacao ) );
                        codigoJava.append( nodo_1.getCodigoMinusculo() + " = " + nodo_2.getCodigoMinusculo() + ";\n" );
                        break;
            ...
            case 10:    nodo_2 = pilhaSemantica.pop();
                        nodo_1 = pilhaSemantica.pop();
                        pilhaSemantica.push("Math.pow(" + nodo_1.getCodigoMinusculo() + ", " + nodo_2.getCodigoMinusculo() + ")", 10);
                        break;
            ...
            case 14:    nodo_1 = pilhaSemantica.pop();
                        ...
                        codigoJava.append( tabulacao( nivelIdentacao ) );
                        codigoJava.append("System.out.println(\"Informe a variável " + nodo_1.getCodigoMinusculo() + ": \");\n");
                        codigoJava.append( tabulacao( nivelIdentacao ) );
                        codigoJava.append( nodo_1.getCodigoMinusculo() + " = scanner.nextLine();" );
                        break;
            ...
            case 17:    nodo_1 = pilhaSemantica.pop();
                        ...
                        nivelIdentacao++;
                        break;
            case 18:    codigoJava.append( tabulacao( nivelIdentacao ) );
            ...
            case 25:    nodo_1 = pilhaSemantica.pop();
                        codigoJava.append("\n\n");
                        codigoJava.append( tabulacao( nivelIdentacao ) );
                        codigoJava.append( "System.out.println(" + nodo_1.getCodigoMinusculo() + ");\n" );
                        break;
            case 26:    nodo_1 = pilhaSemantica.pop();
                        codigoJava.append( tabulacao( nivelIdentacao ) );
                        codigoJava.append( "for _i" + (nivelIdentacao+"") + " in range ( " + nodo_1.getCodigoMinusculo() + " ):\n" );
                        nivelIdentacao++;
                        break;
            case 27:    nivelIdentacao--;
                        break;    					
            case 28:    codigoJava.append( tabulacao( nivelIdentacao ) );
            ...
            case 30:    nodo_2 = pilhaSemantica.pop(); // exp2
                        ...
                        codigoJava.append("\n");
                        codigoJava.append( tabulacao( nivelIdentacao ) );
                        codigoJava.append( "for(int " + nodo_0.getCodigoMinusculo() + "=" + nodo_1.getCodigoMinusculo() + "; " + nodo_0.getCodigoMinusculo() + "<=" + nodo_2.getCodigoMinusculo() + "; " + nodo_0.getCodigoMinusculo() + "++) { \n" );
                        nivelIdentacao++;
                        break;						
            case 31:    codigoJava.append( tabulacao( nivelIdentacao ) );
            ...
            case 33:    nodo_1 = pilhaSemantica.pop(); // exp1
                        nodo_0 = pilhaSemantica.pop(); // variavel
                        codigoJava.append( tabulacao( nivelIdentacao ) );
                        codigoJava.append( nodo_0.getCodigoMinusculo() + " = fatorial( " + nodo_1.getCodigoMinusculo() + " )\n" );
                        break;	
            case 34:    nodo_2 = pilhaSemantica.pop();
                        nodo_1 = pilhaSemantica.pop();
                        pilhaSemantica.push( "2 * ( " + nodo_1.getCodigoMinusculo() + "+" + nodo_2.getCodigoMinusculo() + ") ", 34 );
                        break;
            case 35:    codigoJava.append("\n");
                        nodo_1 = pilhaSemantica.pop();
                        codigoJava.append( tabulacao( nivelIdentacao ) );
                        codigoJava.append( "switch ( " + nodo_1.getCodigoMinusculo() + " ) { \n" );
                        break;
            case 36:    nodo_1 = pilhaSemantica.pop();
                        codigoJava.append( tabulacao( nivelIdentacao ) );
                        codigoJava.append( tabulacao( nivelIdentacao ) );
                        ...
                        codigoJava.append( tabulacao( nivelIdentacao ) );
                        break;
            case 37:    codigoJava.append( tabulacao( nivelIdentacao ) );
                        codigoJava.append( tabulacao( nivelIdentacao ) );
                        codigoJava.append( "default:\n" );
                        codigoJava.append( tabulacao( nivelIdentacao ) );
                        codigoJava.append( tabulacao( nivelIdentacao ) );
                        break;
            case 38:    codigoJava.append( tabulacao( nivelIdentacao ) );
                        codigoJava.append( tabulacao( nivelIdentacao ) );
                        codigoJava.append( tabulacao( nivelIdentacao ) );
                        nivelIdentacao++;
                        codigoJava.append( "break;\n" );
                        break;
            case 39:    nodo_1 = pilhaSemantica.pop(); // exp1
                        nodo_0 = pilhaSemantica.pop(); // variavel
                        codigoJava.append("\n");
                        codigoJava.append( tabulacao( nivelIdentacao ) );
                        codigoJava.append( "for(var " + nodo_0.getCodigoMinusculo()  + " : " + nodo_1.getCodigoMinusculo() + ") { \n" );
                        nivelIdentacao++;
                        break;
            case 40:    codigoJava.append( tabulacao( nivelIdentacao ) );
                        codigoJava.append("}\n");
                        break;
            case  41:	if (!tabelaSimbolos.containsKey( ultimoLexema )) {
                            pilhaSemantica.push( ultimoLexema, 4 );
                            break;
                        } else {
                            throw new ErroSemanticoException( "Variavel " + ultimoLexema + " ja declarada! linha: " + linhaAtual );
            }
            case  42:	nodo_0 = pilhaSemantica.pop(); // variavel
                        codigoJava.append( nodo_0.getCodigoMinusculo() );
                        pilhaSemantica.push( ultimoLexema, 4 );
                        nivelIdentacao++;
                        break;
            case  43:	codigoJava.append("\n");
                        codigoJava.append( tabulacao( nivelIdentacao ) );
                        codigoJava.append( "var = " );
                        break;
            case  44:	codigoJava.append( ", ");
                        break;
            case  45:	codigoJava.append( ";\n");
                        break;
        }
    }
